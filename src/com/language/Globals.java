...
public class Globals {
    ...
    static {
        ...
        values.put("showLine", new Callable() {
            @Override
            public Object call(Interpreter interpreter, List<Object> arguments) {
        ...
        values.put("string", new Callable() {
            @Override
            public String call(Interpreter interpreter, List<Object> arguments) {
                return Util.stringify(arguments.get(0));
            }
        ...
        values.put("number", new Callable() {
            @Override
        ...
        values.put("randomNumber", new Callable() {
            @Override
            public Double call(Interpreter interpreter, List<Object> arguments) {
                var rand = new Random();
